...
import com.example.api.dto.TestRunRequest;
import com.example.api.dto.TestRunUpdate;
...
import com.example.api.service.TestRunService;
...
public class TestRunController {
    ...
    @PostMapping("/runs")
    public ResponseEntity<TestRun> createTestRun(@RequestBody TestRunRequest testRunRequestDto){
    ...
    @PutMapping("/runs/{id}")
    public ResponseEntity<TestRun> updateTestRun(@PathVariable UUID id,@RequestBody TestRunUpdate testRunUpdateDto){
