package com.example.worker.tests;

import com.example.worker.annotations.Test;
import com.example.worker.dto.TestResult;
import com.example.worker.model.enums.TestRunStatus;
import com.example.worker.service.ReportGenerator;
import com.example.worker.service.HTMLGenerator;
    ...
    public TestResult runUiSearchTest() {
        ...
        try {
            ...
            for (ReportGenerator generator : reportGenerators) {
                ...
                if (generator instanceof HTMLGenerator && reportPath != null) {
