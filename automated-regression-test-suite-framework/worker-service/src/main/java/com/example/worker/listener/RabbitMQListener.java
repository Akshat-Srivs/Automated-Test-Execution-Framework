...
import com.example.worker.dto.TestRunUpdate;
import com.example.worker.model.TestRun;
import com.example.worker.service.TestExecutorService;
...
public class RabbitMQListener {
    ...
    public void handleMessage(TestRun testRun) {
        ...
        TestRunUpdate updateDto = new TestRunUpdate();
